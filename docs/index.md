...
Welcome to the Dewey documentation! This documentation provides comprehensive guides and references for using and developing with Dewey.
...
- [Error Categories](api/error-categories.md)
- [Error Severity](api/error-severity.md)
