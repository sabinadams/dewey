...
impl AppError {
    ...
    pub fn migration(
        message: impl Into<String>,
        subcategory: MigrationSubcategory,
        severity: ErrorSeverity,
    ) -> Self {
    ...
    pub fn keyring(
        message: impl Into<String>,
        subcategory: KeyringSubcategory,
        severity: ErrorSeverity,
    ) -> Self {
    ...
    pub fn validation(
        message: impl Into<String>,
        subcategory: ValidationSubcategory,
        severity: ErrorSeverity,
    ) -> Self {
    ...
    pub fn encryption(
        message: impl Into<String>,
        subcategory: EncryptionSubcategory,
        severity: ErrorSeverity,
    ) -> Self {
    ...
    pub fn key_management(
        message: impl Into<String>,
        subcategory: KeyManagementSubcategory,
        severity: ErrorSeverity,
    ) -> Self {
