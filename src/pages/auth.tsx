...
export default function AuthPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-zinc-50">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl text-center text-zinc-900">
          ...
          <div className="grid gap-4">
            <div className="grid gap-2">
              <Button
                ...
                className="w-full bg-zinc-50 hover:bg-gray-50"
              >
            ...
            <form onSubmit={handleSubmit} className="grid gap-4">
              <div className="grid gap-2">
                <label htmlFor="email" className="text-sm font-medium leading-none text-zinc-900 peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  Email
                </label>
                <Input
                  id="email"
              ...
              <div className="grid gap-2">
                <label htmlFor="password" className="text-sm font-medium leading-none text-zinc-900 peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  Password
                </label>
                <Input
                  id="password"
            ...
            <div className="text-center text-sm text-zinc-600">
              ...
              <Button
                variant="link"
                className="px-0 text-zinc-900 hover:text-zinc-700"
